...
export default class ApprovalPopup extends React.Component<{}, any> {
  constructor(props) {
    super(props);
    this.state = {
      items: [],
    ...
    this.setState(
      ...
      () => {
        this.setState({
          ...
          Section: this.state.UniqueItem.SubDepartment,
        });
      }
    );
  };
          ...
          {this.state.Denystatus ? (
            <div>
              <Stack horizontal tokens={stackTokens}>
                ...
                />
                {this.state.Section != "" && this.state.Section != null ? (
                  <TextField
                    label="Section"
                    disabled
                  ...
                  <tr className={styles.Popup}>
                    ...
                    >
                      <Persona
                        ...
                        secondaryText={this.state.Approver_A.EmailID}
                    ...
                    <td style={{ width: "70%", padding: "10px" }}>
                      <Persona
                        ...
                        secondaryText={this.state.Approver_B.EmailID}
                        size={PersonaSize.size56}
