...
const textFieldSingle: Partial<ITextFieldStyles> = {
  fieldGroup: { width: 300 },
};
const textFieldMultiple: Partial<ITextFieldStyles> = {
...
export default function UploadFile(props) {
  ...
  const toggleHideDialog = () => {
    if (hideDialog) setHideDialog(false);
    else setHideDialog(true);
