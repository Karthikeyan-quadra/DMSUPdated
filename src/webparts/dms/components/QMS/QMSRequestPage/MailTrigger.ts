...
// import image from "../../../../../Images/Thumbsup.png"
  ...
  const emailProps: IEmailProperties = {
    ...
    <body>
      ...
      <p style="text-align: center;">
        <img src="../../../../../Images/Thumbsup.png" alt="Thumbs up" width="189" height="190">
      </p>
...
export async function Denymail(Content, Sender, Comment) {
  ...
  const emailProps: IEmailProperties = {
    ...
    <body>
      ...
      <p style="text-align: center;" aria-hidden="true">&nbsp;</p>
      <p style="text-align: center;">
        <img src="../../../../../Images/Thumbsdown.png" alt="Thumbs down" width="189" height="190">
      </p>
      <h4 style="text-align: center;">&nbsp;</h4>
      <h4 style="text-align: center;">Approval Info</h4>
...
//       <p style="text-align: center;" aria-hidden="true">&nbsp;</p>
//       <p style="text-align: center;">
//         <img src="https://cdn-icons-png.flaticon.com/512/2489/2489187.png" alt="Girl in a jacket" width="189" height="190">
//       </p>
//       <h4 style="text-align: center;">&nbsp;</h4>
//       <h4 style="text-align: center;">Approval Info</h4>
//       <p style="text-align: center;">
...
//       <p style="text-align: center;" aria-hidden="true">&nbsp;</p>
//       <p style="text-align: center;">
//         <img src="https://cdn-icons-png.flaticon.com/512/2489/2489190.png" alt="Girl in a jacket" width="189" height="190">
//       </p>
//       <h4 style="text-align: center;">&nbsp;</h4>
//       <h4 style="text-align: center;">Approval Info</h4>
