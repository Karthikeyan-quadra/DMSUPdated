            ...
            .then(async (items: any[]) => {
              if (items.length > 0) {
                sp.web.lists
                  ...
                  .update({
                    EmailID: this.state.Approver_A.EmailID,
                    Name: this.state.Approver_A.Name,
                ...
                await sp.web.lists
                  ...
                  .items.add({
                    ...
                    Name: this.state.Approver_A.Name,
                    //Authority: this.state.Approver_A.Authority,
                    Level: this.state.Approver_A.Level,
                    ApproverLevel: this.state.Approver_A.ApproverLevel,
                    Department: this.state.Approver_A.Department,
                    SubDepartment: this.state.Approver_A.SubDepartment,
                  })
                  .then((result) => {
                    this.setState({ hideDialog: false });
                    console.log(JSON.stringify(result));
            ...
            .then(async (items: any[]) => {
              if (items.length > 0) {
                sp.web.lists
                  ...
                  .items.getById(items[0].Id)
                  .update({
                    EmailID: this.state.Approver_B.EmailID,
                    Name: this.state.Approver_B.Name,
                    // Authority: this.state.Approver_B.Authority,
                  })
                  .then((result) => {
                    this.setState({ hideDialog: false });
                    console.log(JSON.stringify(result));
                ...
                await sp.web.lists
                  ...
                  .items.add({
                    ...
                    Name: this.state.Approver_B.Name,
                    //Authority: this.state.Approver_B.Authority,
                    Level: this.state.Approver_B.Level,
                    ApproverLevel: this.state.Approver_B.ApproverLevel,
                    Department: this.state.Approver_B.Department,
                    SubDepartment: this.state.Approver_B.SubDepartment,
                  })
                  .then((result) => {
                    this.setState({ hideDialog: false });
                    console.log(JSON.stringify(result));
        ...
        <div>
          <Stack horizontal tokens={stackTokens}>
            <ComboBox
              ...
              required
              errorMessage={this.state.errlevelmsg}
              options={this.state.levelitems}
            ...
            {!this.state.sub_Status ? (
              <ComboBox
                ...
                required
                errorMessage={this.state.errmsg}
                options={this.state.SubDepartmentlist}
            ...
            <div>
              ...
              <Stack horizontal tokens={stackTokens}>
                <ComboBox
                  ...
                  label="Approver 2"
                  errorMessage={this.state.errmsgApproverA}
            ...
            <table style={{ tableLayout: "fixed", width: "70%" }}>
              <tr className={styles.Popup}>
                ...
                >
                  <Persona
                    showUnknownPersonaCoin={
                      this.state.Approver_A.Name == "Not Assigned"
                        ? true
                        : false
                    }
                    text={this.state.Approver_A.Name}
                    ...
                    imageAlt={this.state.Approver_A.Name}
                  />
                </td>
                ...
                <td style={{ width: "70%", padding: "10px" }}>
                  <Persona
                    showUnknownPersonaCoin={
                      this.state.Approver_B.Name == "Not Assigned"
                        ? true
                        : false
                    }
                    text={this.state.Approver_B.Name}
                    tertiaryText="File Approver"
                    secondaryText={
                      this.state.Approver_B.Name != "Not Assigned"
                        ? this.state.Approver_B.EmailID
                        : ""
                    }
                    size={PersonaSize.size72}
                    imageAlt={this.state.Approver_B.Name}
                  />
                </td>
              </tr>
            </table>
